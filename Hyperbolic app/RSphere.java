...
class RSphere {
    ...
    void setStructure(double s) {
        ...
        C11=C11.scale(C21.a.convert(sym,0.0),C11);
        C22=C22.scale(C22.a.convert(sym,0.0),C22);
        Z5=new Complex();
        Z7=new Complex();
        Z6=new Complex();
        Z8=new Complex();
    ...
    double getPLAN2Aspect() {
        ...
        Complex z5=z1.minus(z4,z3);
        Complex z6=z1.minus(z1,z2);
        double d=z5.norm(z5)/z6.norm(z6);
        return(d);
    }
    ...
    double getELEV1Scale() {
        ...
        while(sign==0) {
            t3=0.5*t1+0.5*t2;
            if(s<=2) {
                m.b=m.a.scale(m.a.a.convert(t3,0.0),P0);
                m.a=C12;
            }
            if(s>2) {
                m.b=m.a.scale(m.a.a.convert(t3,0.0),C11);
                m.a=C12;
            }
    ...
    double getOptimalWeight() {
        ...
        while(sign==0) {
            t3=0.5*t1+0.5*t2;
            m.a=m.a.scale(m.a.a.convert(t3,0.0),C11);
            m.b=C12;
