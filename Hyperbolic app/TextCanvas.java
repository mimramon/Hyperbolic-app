/*TEXT AND DOCUMENTATION. The rest of the applet is just
strings of text, with a few buttons through in to help
the user navigate the text.*/
...
class TextCanvas extends DoubleBufferedCanvas implements MouseListener
{
    ...
    public void paint(Graphics gfx) {
        ...
        if(MESSAGE==1001) {
            ...
            Integer I=new Integer(0);
            for(int i=1;i<=6;++i) {
                g.drawString(I.toString(i+8),312+48*i-45,160);
            }
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if(L[12].inside(p)==1) {D.ACTIVE=1;D.repaint();}
        if(L[14].inside(p)==1) {D.ACTIVE=0;D.repaint();}
        repaint();
    ...
    void setPage() {
        ...
        if(MESSAGE==922) {
            ...
            St[32]="This result on inflection points, would";
            St[33]="prove ELEV2(C1) # ELEV2(C2)=ELEV2(p0).";
