...
class PlotCanvas extends DoubleBufferedCanvas implements MouseListener, MouseMotionListener
{
    ...
    void currentRender(Graphics g)
    {
        ...
        {
            test = Math.abs(A[i].z1.x - A[i].z2.x);
            if (test < 2.0)
            {
    ...
    void HQ_set(Color C)
    {
        ...
        Vector v2;
        double u2;
        v1.a = new Complex(1.0, 0.0);
        v1.b = new Complex(0.0, 0.0);
        v1.c = new Complex(1.0, 0.0);
        NUMBER = 0;
        if (TYPE == 3)
        {
            NUMBER = n;
            ...
            m.a = S1.M1.b;
            m.b = S1.M1.c;
            m.c = Vector.spinalExtension(m.a, m.b, v1);
            m2.a = m.c;
            m2.b = m.b;
            m2.c = m.a;
    ...
    Complex doCoords(Vector v1)
    {
        ...
        if ((TYPE == 1) && (MODE == 0))
        {
            Complex u = Complex.inverse(S1.Z3);
            u.x = -u.x;
            u.y = -u.y;
            A = S1.M2.ELEV1(v1, u);
            A.x = 4 * A.x - 2;
        ...
        if ((TYPE == 2) && (MODE == 0))
        {
            Complex w = Complex.inverse(S1.Z3);
            w = Complex.unit(w);
            A = S1.M2.PLAN1(v1);
            A = Complex.times(A, w);
            A.y = -A.y / S1.Z6.y;
        ...
        if ((TYPE == 2) && (MODE == 1))
        {
            Complex w = Complex.inverse(S1.Z4);
            w = Complex.unit(w);
            A = S1.M1.PLAN2(v1);
            A = Complex.times(A, w);
            A.y = -A.y / S1.Z7.y;
        ...
        {
            A = S1.M1.HYP1(v1);
            Complex z1 = Complex.minus(A, S1.Z1);
            Complex z2 = Complex.minus(A, S1.Z2);
            A = Complex.divide(z1, z2);
            A = Complex.divide(A, new Complex(S1.Z5.y, 0.0));
            A.x = -2.0 * A.x;
            A.y = 2.0 * A.y;
        }
