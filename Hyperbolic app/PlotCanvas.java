...
class PlotCanvas extends DoubleBufferedCanvas implements MouseListener, MouseMotionListener
{
    ...
    void HQ_set(Color C)
    {
        ...
        double u1 = 0;
        double u2 = 0;
        v1.a = new Complex(1, 0);
        v1.b = new Complex();
        v1.c = new Complex(1, 0);
        NUMBER = 0;
        if (TYPE == 3)
        {
            NUMBER = n;
    ...
    Complex doCoords(Vector v1)
    {
        ...
        if ((TYPE == 2) && (MODE == 0))
        {
            ...
            w = Complex.inverse(S1.Z3);
            w = Complex.unit(w);
            A = S1.M2.PLAN1(v1);
            A = Complex.multiply(A, w);
            A.y = -A.y / S1.Z6.y;
            A.x = A.x / S1.Z6.y;
        }
        ...
        {
            A = S1.M1.HYP1(v1);
            Complex z1 = Complex.subtract(A, S1.Z1);
            Complex z2 = Complex.subtract(A, S1.Z2);
